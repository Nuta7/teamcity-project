...
import com.example.teamcity.ui.enums.SystemProjectId;
...
public class CreateProjectTest extends BaseUiTest {
    ...
    public void userCreatesProject(){
        ...
        // взаимодействие с UI
        CreateProjectPage.open(SystemProjectId.ROOT.getId())
                .createForm(REPO_URL)
        ...
        var createdProject = superUserCheckRequests.<Project>getRequest(Endpoint.PROJECTS).read(LocatorType.NAME.format(testData.getProject().getName()));

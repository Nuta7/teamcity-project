...
public class BuildTypeTest extends BaseApiTest {
    ...
    public void userCreatesTwoBuildTypesWithTheSameIdTest() {
        ...
        new UncheckedBase(Specifications.authSpec(user), BUILD_TYPES)
                ...
                .body("errors[0].message",Matchers.equalTo("The build configuration / template ID \"%s\" is already used by another configuration or template".formatted(buildType1.getId())));
    }
